 ...
 *         &lt;element name="free-gygabytes" type="{http://www.w3.org/2001/XMLSchema}double"/>
 *         &lt;element name="free-minutes" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
public class TariffType {
     ...
     * 
     */
    public void setFreeMinutes(int value) {
	...
	public String toString() {
		return "TariffType [name=" + name + ", operatorName=" + operatorName
				...
				+ ", smsPrice=" + smsPrice + ", freeGygabytes=" + freeGygabytes
				+ ", freeMinutes=" + freeMinutes + ", parameters=" + parameters
				+ "]";
	}
